List<Map> cityNames = [
  ...
  {'city': 'Cawnpore', 'state': 'Uttar Pradesh'},
  ...
  {'city': 'Chinchvad', 'state': 'Maharashtra'},
  ...
  {'city': 'Bezwada', 'state': 'Andhra Pradesh'},
  ...
  {'city': 'Trichinopoly', 'state': 'Tamil Nadu'},
  {'city': 'Hubli', 'state': 'Karnataka'},
  {'city': 'Jalandhar', 'state': 'Punjab'},
  {'city': 'Bhubaneshwar', 'state': 'Odisha'},
  {'city': 'Bhayandar', 'state': 'Maharashtra'},
  ...
  {'city': 'Tinnevelly', 'state': 'Tamil Nadu'},
  ...
  {'city': 'Rajapalaiyam', 'state': 'Tamil Nadu'},
  ...
  {'city': 'Shahjanpur', 'state': 'Uttar Pradesh'},
  ...
  {'city': 'Shiliguri', 'state': 'West Bengal'},
  {'city': 'Bali', 'state': 'West Bengal'},
  ...
  {'city': 'Ramgundam', 'state': 'Telangana'},
  {'city': 'Hapur', 'state': 'Uttar Pradesh'},
  {'city': 'Uluberiya', 'state': 'West Bengal'},
  ...
  {'city': 'Ghandinagar', 'state': 'Gujarat'},
